...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "Mức độ vô tri " + (thePercent+899);
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp;Vô tri như vậy là vì';
document.querySelector('.Description .modal-body').innerHTML = 'Vì em vô tri! ';
var author = document.querySelector('.author .me');author.style.opacity = "0.5";
author.innerHTML = "By<a href='https://www.facebook.com/profile.php?id=100085820164516'>V<a>";
